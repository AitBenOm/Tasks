...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__tasks_task_add_task_add_component__ = __webpack_require__("../../../../../src/app/tasks/task-add/task-add.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__tasks_task_list_task_list_component__ = __webpack_require__("../../../../../src/app/tasks/task-list/task-list.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__tasks_taskService__ = __webpack_require__("../../../../../src/app/tasks/taskService.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["E" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_3__tasks_task_add_task_add_component__["a" /* TaskAddComponent */],
                __WEBPACK_IMPORTED_MODULE_4__tasks_task_list_task_list_component__["a" /* TaskListComponent */],
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_6__tasks_taskService__["a" /* TaskService */]],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__taskService__ = __webpack_require__("../../../../../src/app/tasks/taskService.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TaskAddComponent = (function () {
    ...
    TaskAddComponent.prototype.onAddTask = function (event) {
        var _this = this;
        var task = new __WEBPACK_IMPORTED_MODULE_1__task_model__["a" /* Task */](event.target.value, false, this.getToDayString());
        this.taskService.addTask(task).subscribe(function (newTask) {
            _this.addTaskValue = ' ';
            _this.taskService.onTaskAdded.emit(newTask);
        });
    };
    TaskAddComponent.prototype.getToDayString = function () {
        var toDay = new Date();
        var dd = toDay.getDay();
    ...
    TaskAddComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            ...
            template: __webpack_require__("../../../../../src/app/tasks/task-add/task-add.component.html"),
            styles: [__webpack_require__("../../../../../src/app/tasks/task-add/task-add.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__taskService__["a" /* TaskService */]])
    ], TaskAddComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__taskService__ = __webpack_require__("../../../../../src/app/tasks/taskService.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TaskListComponent = (function () {
    ...
    TaskListComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__taskService__["a" /* TaskService */]])
    ], TaskListComponent);
